...
class Concept():
  ...
  def __init__(self, cName, a, f, t, attrib , tag):
...
class Jasmine():
    ...
    for word in words:
      ...
      if(found == 0):
        ...
        if ans == "Yes" or ans == "yes":
          ...
          self.learnConceptWithHuman(word, words,indexTag,tag)
  ...
  def learnConceptWithHuman(self, word, words,indexTag,tag):
    print(word ,indexTag,tag)
    ...
    if ans == "Yes" or ans == "yes":
      ...
      cName = self.askThis("What is the name of the concept?")
      print(indexTag)
      if indexTag == 0 or indexTag==1:
        act = "add node"
        fName = None
        tName = None
        aName = None
        con = Concept(cName, act, fName, tName, aName, tag)
        con.addWordToConcept(word)
        self.mind.addConcept(con)
          
      elif (indexTag == 2 or indexTag == 3):
        act = "add edge"
